      ...
      <div className="h-40  relative flex items-center overflow-hidden">
        ...
        >
          <p
            ...
            className="text-base sm:text-[3rem] py-20 font-bold text-black bg-clip-text text-transparent bg-gradient-to-b from-white to-[#0eff06]"
          >
            {revealText}
          </p>
        </motion.div>
        ...
        <div className=" overflow-hidden [mask-image:linear-gradient(to_bottom,transparent,white,transparent)]">
          <p className="text-base sm:text-[3rem] py-10 font-bold bg-clip-text text-transparent bg-[#0eff06]">
            {text}
          </p>
          <MemoizedStars />
        </div>
