          ...
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center">
            <div className="bg-white p-6 rounded-lg shadow-lg max-w-md w-full max-h-[80vh] overflow-y-auto">
              ...
              <p className="text-gray-700 mb-4 text-justify">
                ...
                debe utilizar nuestro sitio. <br />
                ...
                ARS Racing no se hace responsable de ningún uso no autorizado de
                su cuenta.
                ...
                línea muy en serio. Ofrecemos opciones de pago seguras a través
                de proveedores de servicios de pago externos certificados. Al
                hacer un pedido, acepta que podemos almacenar y procesar su
                información de pago en cumplimiento con las normativas
                aplicables de seguridad de datos. Toda la información
                confidencial relacionada con los pagos, incluidas las tarjetas
                de crédito o débito, es tratada de manera segura a través de la
                tecnología de encriptación estándar en la industria. Sin
                embargo, ARS Racing no se responsabiliza por daños o pérdidas
                causadas por el uso no autorizado de su información financiera.
                ...
                con el pedido realizado. Para iniciar una solicitud de reembolso
                o cambio, el cliente debe contactarnos dentro de los primeros 7
                días hábiles desde la recepción del pedido.
                <br />
                <strong>6. Propiedad Intelectual</strong>
                <br /> Todo el contenido de este sitio web, incluyendo pero no
                limitado a imágenes, gráficos, textos y logotipos, es propiedad
                de ARS Racing y está protegido por las leyes de propiedad
