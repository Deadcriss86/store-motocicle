  ...
  return (
    <footer className="footer p-10 bg-base-300 text-base-content dark:bg-black">
      ...
      <div className="text-white">
        ...
        <a className="link link-hover">Móvil +52 4575965487</a>
      </div>
      <div className="grid grid-flow-col gap-4 border-[#0eff06] border-t-2 p-8">
        <a>
          <svg
        ...
        <a>
          <svg
            ...
            height="24"
            viewBox="0 0 24 24"
            className="fill-current text-[#0eff06] link link-hove"
          >
