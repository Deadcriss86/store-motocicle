  ...
  return (
    <>
      <div className="bg-black min-h-screen">
        ...
        <div className="sticky top-0 h-auto flex flex-col items-center justify-center bg-gradient-to-b from-[#0d4d0b] to-black">
        ...
        <div className="sticky top-0 h-auto flex flex-col items-center justify-center bg-gradient-to-b from-black to-[#082707] text-white ">
